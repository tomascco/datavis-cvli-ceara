function ready(fn) {
  ...
  async function updateData2() {
    ...
    crime_scale2 = d3.scaleQuantize().domain([0, max_value+20]).range(d3.schemeReds[9])
  
    var ais_groups=['AIS 1', 'AIS 2', 'AIS 3', 'AIS 4', 'AIS 5', 'AIS 6', 'AIS 7', 'AIS 8', 
                    'AIS 9', 'AIS 10']
    
    
    let crime_scale2 = d3.scaleSequential().domain([min_value-10, max_value+20])
    .interpolator(d3.interpolateReds)
    lineplot_2(facts_fortaleza);
    map2.remove();
    renderMap3(facts_fortaleza,crime_scale2,AIS_pop,map_AIS_count,AIS_MUN);
    horizontalbar2(facts_fortaleza,ais_groups,AIS_df,AIS_pop,crime_scale2,ais_group,ais_dim)
    histogram3(facts_fortaleza);
    heatmapdays(facts_fortaleza);
    document.getElementById("demo2").innerHTML = "<b>Mapa e gráfico de barra estão considerando os dados Brutos</b>";
  
    dc.renderAll();
  }
  
  async function originalData2(){
    ...
    let ais_groups=['AIS 11','AIS 12', 'AIS 13', 'AIS 14', 'AIS 15', 'AIS 16', 'AIS 17', 'AIS 18', 'AIS 19', 'AIS 20', 
                    'AIS 21', 'AIS 22']
    ...
    renderMap3(facts_fortaleza,crime_scale2,AIS_pop,map_AIS_count,AIS_MUN);
    horizontalbar2(facts_fortaleza,ais_groups,AIS_df,AIS_pop,crime_scale2,ais_group,ais_dim)
    document.getElementById("demo2").innerHTML = "</b>Mapa e gráfico de barra estão considerando a Taxa de CVLI por 100.000 mill habitantes</b>";
  ...
  async function  renderMap3(facts,crime_scale2,AIS_pop,map_AIS_count,bairro_AIS_map){
    ...
    d3.select('#clear-all').on('click', () => {
      ...
      dc.redrawAll();
      map.setView([-3.792614,-38.515877], 11);
    });
    ...
    infoControl.onAdd = function (map2) {
